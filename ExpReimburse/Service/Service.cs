...
public  class ServiceClass{
    ...
    public async Task<Ticket> sumbitTicket(Ticket ticket){
        ...
        if(ticket.description == "" || ticket.ticketType == "" ){
            return null;
        }else{
    ...
    // view ticket history
    public async Task<List<Ticket>> viewTicket(User user){

        List<Ticket> ticketHistory = await DatabaseTicket.getTicket(user);
        return ticketHistory;
    }


    // view pending ticket
    public async Task<List<Ticket>> viewTicket(){

        List<Ticket> pendingTicket = await DatabaseTicket.ViewPendingTicket();
